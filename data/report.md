...
**Checked at:** 09:07 IST  
**Decision:** 🔴 **TRADE PE**  
**Instrument:** NIFTY 23500 PE  

Nifty **23505** is below yesterday's low **23623** — breakdown confirmed. PE setup is active.

### Live context

- Nifty now: **23505.25**
- Day open: 23522.05 (gap -0.48%)
- Move from open: -0.07%
- PE trigger (below): **23623.1**
- CE trigger (above): **23758.95**
...
- **Avg Nifty move from signal:** +0.11%

### Recent Nifty signals

| Date | Time | Action | Instrument | Nifty @ signal | EOD | Move % | Outcome |
|------|------|--------|------------|---------------:|----:|-------:|---------|
| 2026-09-09 | 09:07 IST | TRADE PE | NIFTY 23500 PE | 23505.25 | — | — | pending |
...
**Trading days in history:** 9

## Nifty daily plan (tomorrow)

**Spot:** 23635.1 (-0.61% today)  
**Regime:** BEARISH  
...
- Yesterday's high: **23890.0** (CE trigger above this)
- Yesterday's low: **23737.9** (PE trigger below this)
- 50-day average: 24196.32
- 200-day average: 24589.32

### Tomorrow's plan

**Bias: PE** — Nifty breaks below **23738** (yesterday's low) in the first 30–60 min. Strike: **NIFTY 23650 PE** (ATM) or **23600 PE** (slightly OTM). Book half at +50% premium, rest at +80–100%. Cut at -40%.
