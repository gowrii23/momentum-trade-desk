...
**Checked at:** 09:05 IST  
**Decision:** 🔴 **TRADE PE**  
**Instrument:** NIFTY 23400 PE  

Nifty **23414** is below yesterday's low **23432** — breakdown confirmed. PE setup is active.

### Live context

- Nifty now: **23413.55**
- Day open: 23446.6 (gap +0.06%)
- Move from open: -0.14%
- PE trigger (below): **23431.5**
- CE trigger (above): **23571.55**
...
|------|------|--------|------------|---------------:|----:|-------:|---------|
| 2026-09-10 | 09:05 IST | TRADE PE | NIFTY 23400 PE | 23413.55 | — | — | pending |
...
**Symbols scanned:** 2681  
**Trading days in history:** 10

## Nifty daily plan (tomorrow)

**Spot:** 23431.5 (-0.86% today)  
**Regime:** BEARISH  
...
- Yesterday's high: **23758.95** (CE trigger above this)
- Yesterday's low: **23623.1** (PE trigger below this)
- 50-day average: 24184.83
- 200-day average: 24576.93

### Tomorrow's plan

**Bias: PE** — Nifty breaks below **23623** (yesterday's low) in the first 30–60 min. Strike: **NIFTY 23450 PE** (ATM) or **23400 PE** (slightly OTM). Book half at +50% premium, rest at +80–100%. Cut at -40%.
